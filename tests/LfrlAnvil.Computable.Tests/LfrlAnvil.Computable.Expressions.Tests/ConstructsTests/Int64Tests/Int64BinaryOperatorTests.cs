                ...
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantResult =>
                                constantResult.Value.TestEquals( 579L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantResult =>
                                constantResult.Value.TestEquals( -333L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantResult =>
                                constantResult.Value.TestEquals( 56088L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantResult =>
                                constantResult.Value.TestEquals( 0L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantResult =>
                                constantResult.Value.TestEquals( 309L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantResult =>
                                constantResult.Value.TestEquals( 87L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantExpression =>
                                constantExpression.Value.TestEquals( 72L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantExpression =>
                                constantExpression.Value.TestEquals( 0L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantExpression =>
                                constantExpression.Value.TestEquals( 507L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantExpression =>
                                constantExpression.Value.TestEquals( 435L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantExpression =>
                                constantExpression.Value.TestEquals( 1867776L ) ) ) );
    }
            ...
            (_, _, result) =>
                Assertion.All(
                    ...
                    result.TestIf()
                        .OfType<ConstantExpression>(
                            constantExpression =>
                                constantExpression.Value.TestEquals( 456L ) ) ) );
    }
