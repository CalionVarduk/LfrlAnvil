    ...
    public class EnumerableExtensionsTestsData<T>
    {
        public static IEnumerable<object?[]> CreateFlattenTestData(IFixture fixture)
        {
            ...
            return new[]
            {
                ...
                new object?[]
                {
                    new[] { new Pair<T, IEnumerable<T>>( _1, new[] { _2 } ) }, new[] { Common.Pair.Create( _1, _2 ) }
                },
                new object?[]
                {
                    ...
                    new[]
                    {
                        Common.Pair.Create( _1, _2 ),
                        Common.Pair.Create( _1, _3 ),
                        Common.Pair.Create( _2, _1 ),
                        Common.Pair.Create( _2, _3 )
                    }
                }
            };
        }
