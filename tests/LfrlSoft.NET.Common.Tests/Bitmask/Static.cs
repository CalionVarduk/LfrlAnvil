...
namespace LfrlSoft.NET.Common.Tests.Bitmask
{
    ...
    public class Static
    {
        ...
        {
            var result = Common.Bitmask.GetUnderlyingType( null );
        ...
        {
            var result = Common.Bitmask.GetUnderlyingType( type );
        ...
        public void GetUnderlyingType_ShouldReturnCorrectType_WhenTypeIsCorrectAndOpen()
        {
            ...
            var result = Common.Bitmask.GetUnderlyingType( typeof( Bitmask<> ) );
