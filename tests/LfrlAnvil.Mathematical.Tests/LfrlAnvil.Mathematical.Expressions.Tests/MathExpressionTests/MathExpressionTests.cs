...
namespace LfrlAnvil.Mathematical.Expressions.Tests.MathExpressionTests;

public class MathExpressionTests : TestsBase
{
    [Fact]
    ...
    public void ToString_ShouldReturnInfoAboutGenericArgumentsAndInput()
    {
        ...
        var builder = new MathExpressionFactoryBuilder()
            .AddBinaryOperator( "+", new MathExpressionAddOperator() )
            .AddPrefixTypeConverter( "[double]", new MathExpressionTypeConverter<double>() )
            .SetBinaryOperatorPrecedence( "+", 1 )
        ...
        BindArguments_ShouldThrowMathExpressionArgumentBindingException_WhenAnyArgumentToBindDoesNotExistInUnboundArgumentsCollection()
    {
        ...
        action.Should().ThrowExactly<MathExpressionArgumentBindingException>();
    }
    ...
    public void IMathExpressionBindArguments_WithEnumerableStringKey_ShouldBeEquivalentToBindArguments()
    {
        ...
        var factory = builder.Build();
        IMathExpression<decimal, decimal> sut = factory.Create<decimal, decimal>( input );
    ...
    private sealed class ExternalArrayIndexUnaryOperator : MathExpressionUnaryOperator
    {
    ...
    private sealed class ParameterAccessorWithConstantIndexUnaryOperator : MathExpressionUnaryOperator
    {
    ...
    private sealed class ParameterAccessorWithVariableIndexUnaryOperator : MathExpressionUnaryOperator
    {
