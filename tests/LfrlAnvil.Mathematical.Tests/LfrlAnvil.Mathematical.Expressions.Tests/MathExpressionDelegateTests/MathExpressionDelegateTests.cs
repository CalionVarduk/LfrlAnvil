...
namespace LfrlAnvil.Mathematical.Expressions.Tests.MathExpressionDelegateTests;

public class MathExpressionDelegateTests : TestsBase
{
    [Fact]
        ...
        int valuesCount)
    {
        ...
        action.Should()
            .ThrowExactly<InvalidMathExpressionArgumentCountException>()
