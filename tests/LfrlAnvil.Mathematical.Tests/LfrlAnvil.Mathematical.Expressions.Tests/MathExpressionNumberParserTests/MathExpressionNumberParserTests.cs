...
namespace LfrlAnvil.Mathematical.Expressions.Tests.MathExpressionNumberParserTests;

public class MathExpressionNumberParserTests : TestsBase
{
    [Theory]
    ...
    public void DefaultDecimal_ShouldReturnTrueAndCorrectDecimal_WhenParsingIsPossible(
        ...
        double? expected)
    {
        var parser = MathExpressionNumberParser.CreateDefaultDecimal( GetConfiguration( allowNonIntegerNumbers, allowScientificNotation ) );
    ...
    public void DefaultDouble_ShouldReturnTrueAndCorrectDouble_WhenParsingIsPossible(
        ...
        double? expected)
    {
        var parser = MathExpressionNumberParser.CreateDefaultDouble( GetConfiguration( allowNonIntegerNumbers, allowScientificNotation ) );
    ...
    public void DefaultFloat_ShouldReturnTrueAndCorrectFloat_WhenParsingIsPossible(
        ...
        float? expected)
    {
        var parser = MathExpressionNumberParser.CreateDefaultFloat( GetConfiguration( allowNonIntegerNumbers, allowScientificNotation ) );
    ...
    public void DefaultInt32_ShouldReturnTrueAndCorrectInt_WhenParsingIsPossible(
        ...
        int? expected)
    {
        var parser = MathExpressionNumberParser.CreateDefaultInt32( GetConfiguration( allowNonIntegerNumbers, allowScientificNotation ) );
    ...
    public void DefaultInt64_ShouldReturnTrueAndCorrectLong_WhenParsingIsPossible(
        ...
        long? expected)
    {
        var parser = MathExpressionNumberParser.CreateDefaultInt64( GetConfiguration( allowNonIntegerNumbers, allowScientificNotation ) );
    ...
    public void DefaultBigInteger_ShouldReturnTrueAndCorrectBigInt_WhenParsingIsPossible(
        ...
        long? expected)
    {
        var parser = MathExpressionNumberParser.CreateDefaultBigInteger(
    ...
    private static MathExpressionFactoryInternalConfiguration GetConfiguration(bool allowNonIntegerNumbers, bool allowScientificNotation)
    {
        ...
        return new MathExpressionFactoryInternalConfiguration(
            new Dictionary<StringSlice, MathExpressionConstructTokenDefinition>(),
            configuration );
    }
}
