...
namespace LfrlSoft.NET.Core.Tests.Pair
{
    public class Static
    {
        ...
        {
            var result = Core.Pair.GetUnderlyingFirstType( null );
        ...
        {
            var result = Core.Pair.GetUnderlyingFirstType( type );
        ...
        public void GetUnderlyingFirstType_ShouldReturnCorrectType_WhenTypeIsCorrectAndOpen()
        {
            ...
            var result = Core.Pair.GetUnderlyingFirstType( typeof( Pair<,> ) );
        ...
        {
            var result = Core.Pair.GetUnderlyingSecondType( null );
        ...
        {
            var result = Core.Pair.GetUnderlyingSecondType( type );
        ...
        public void GetUnderlyingSecondType_ShouldReturnCorrectType_WhenTypeIsCorrectAndOpen()
        {
            ...
            var result = Core.Pair.GetUnderlyingSecondType( typeof( Pair<,> ) );
        ...
        {
            var result = Core.Pair.GetUnderlyingTypes( null );
        ...
        {
            var result = Core.Pair.GetUnderlyingTypes( type );
        ...
        public void GetUnderlyingTypes_ShouldReturnCorrectTypes_WhenTypeIsCorrectAndOpen()
        {
            ...
            var result = Core.Pair.GetUnderlyingTypes( typeof( Pair<,> ) );
