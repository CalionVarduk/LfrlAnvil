...
namespace LfrlSoft.NET.Core.Tests.ChronoTests.ZonedMonthTests
{
    public class ZonedMonthTestsData
    {
        ...
        public static TheoryData<DateTime, TimeZoneInfo, int, TimeOfDay, DateTime> GetGetDateTimeData(IFixture fixture)
        {
            var month = new DateTime( 2021, 8, 1 );
            var timeZone = TimeZoneFactory.Create( 1 );
            var timeZoneWithInvalidity = TimeZoneFactory.Create(
            ...
            return new TheoryData<DateTime, TimeZoneInfo, int, TimeOfDay, DateTime>
            {
                { month, timeZone, 1, TimeOfDay.Start, month },
                { month, timeZone, 24, TimeOfDay.Mid, new DateTime( 2021, 8, 24, 12, 0, 0 ) },
                { month, timeZone, 31, TimeOfDay.End, new DateTime( 2021, 8, 31, 23, 59, 59, 999 ).AddTicks( 9999 ) },
                { new DateTime( 2020, 2, 1 ), timeZone, 29, TimeOfDay.Mid, new DateTime( 2020, 2, 29, 12, 0, 0 ) },
                {
                    month,
                    timeZone,
                    14,
                    new TimeOfDay( 12, 30, 40, 500, 6001 ),
                    new DateTime( 2021, 8, 14, 12, 30, 40, 500 ).AddTicks( 6001 )
                },
                {
                    month,
        ...
        public static TheoryData<DateTime, TimeZoneInfo, int, TimeOfDay> GetGetDateTimeThrowDueToTimeData(IFixture fixture)
        {
            var month = new DateTime( 2021, 8, 1 );
            var timeZoneWithInvalidity = TimeZoneFactory.Create(
                utcOffsetInHours: 1,
            ...
            return new TheoryData<DateTime, TimeZoneInfo, int, TimeOfDay>
            {
                { month, timeZoneWithInvalidity, 26, new TimeOfDay( 12 ) },
                { month, timeZoneWithInvalidity, 26, new TimeOfDay( 12, 59, 59, 999, 9999 ) }
            };
        }

        public static TheoryData<DateTime, TimeZoneInfo, int, TimeOfDay> GetGetDateTimeThrowDueToDayData(IFixture fixture)
        {
            var timeZone = TimeZoneFactory.CreateRandom( fixture );

            return new TheoryData<DateTime, TimeZoneInfo, int, TimeOfDay>
            {
                { new DateTime( 2021, 1, 1 ), timeZone, -1, TimeOfDay.Mid },
                { new DateTime( 2021, 1, 1 ), timeZone, 0, TimeOfDay.Mid },
                { new DateTime( 2021, 2, 1 ), timeZone, 29, TimeOfDay.Mid },
                { new DateTime( 2021, 4, 1 ), timeZone, 31, TimeOfDay.Mid },
                { new DateTime( 2021, 12, 1 ), timeZone, 32, TimeOfDay.Mid },
                { new DateTime( 2020, 2, 1 ), timeZone, 30, TimeOfDay.Mid }
            };
        }
