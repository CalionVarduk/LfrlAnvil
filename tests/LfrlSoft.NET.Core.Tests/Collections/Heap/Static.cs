...
namespace LfrlSoft.NET.Core.Tests.Collections.Heap
{
    public class Static : TestsBase
    {
        ...
        {
            var result = Core.Collections.Heap.GetParentIndex( childIndex );
        ...
        {
            var result = Core.Collections.Heap.GetLeftChildIndex( parentIndex );
        ...
        {
            var result = Core.Collections.Heap.GetRightChildIndex( parentIndex );
