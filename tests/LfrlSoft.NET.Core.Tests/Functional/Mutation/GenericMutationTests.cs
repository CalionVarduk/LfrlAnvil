...
namespace LfrlSoft.NET.Core.Tests.Functional.Mutation
{
        ...
        where T : notnull
    {
        ...
        public void Create_ShouldCreateCorrectResult_WhenValuesAreDifferent()
        {
            ...
            var sut = Core.Functional.Mutation.Create( oldValue, value );
        ...
        public void Create_ShouldCreateCorrectResult_WhenValuesAreEqual()
        {
            ...
            var sut = Core.Functional.Mutation.Create( value, value );
        ...
        public void GetHashCode_ShouldCreateCorrectResult()
        {
            ...
            var expected = Core.Hash.Default.Add( oldValue ).Add( value ).Value;
            var sut = new Mutation<T>( oldValue, value );
        ...
        {
            var result = (Mutation<T>)Core.Functional.Nil.Instance;
