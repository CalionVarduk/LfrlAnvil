...
namespace LfrlSoft.NET.Core.Tests.Functional.Either
{
    public class EitherStaticTests : TestsBase
    {
        ...
        {
            var result = Core.Functional.Either.GetUnderlyingFirstType( null );
        ...
        {
            var result = Core.Functional.Either.GetUnderlyingFirstType( type );
        ...
        public void GetUnderlyingFirstType_ShouldReturnCorrectType_WhenTypeIsCorrectAndOpen()
        {
            ...
            var result = Core.Functional.Either.GetUnderlyingFirstType( typeof( Either<,> ) );
        ...
        {
            var result = Core.Functional.Either.GetUnderlyingSecondType( null );
        ...
        {
            var result = Core.Functional.Either.GetUnderlyingSecondType( type );
        ...
        public void GetUnderlyingSecondType_ShouldReturnCorrectType_WhenTypeIsCorrectAndOpen()
        {
            ...
            var result = Core.Functional.Either.GetUnderlyingSecondType( typeof( Either<,> ) );
        ...
        {
            var result = Core.Functional.Either.GetUnderlyingTypes( null );
        ...
        {
            var result = Core.Functional.Either.GetUnderlyingTypes( type );
        ...
        public void GetUnderlyingTypes_ShouldReturnCorrectTypes_WhenTypeIsCorrectAndOpen()
        {
            ...
            var result = Core.Functional.Either.GetUnderlyingTypes( typeof( Either<,> ) );
