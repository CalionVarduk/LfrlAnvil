...
namespace LfrlSoft.NET.Core.Tests.Chrono.TimeOfDay
{
    ...
    public class TimeOfDayTests : TestsBase
    {
        ...
        {
            var sut = new Core.Chrono.TimeOfDay( hour );
        ...
        {
            var action = Lambda.Of( () => new Core.Chrono.TimeOfDay( hour ) );
        ...
        {
            var sut = new Core.Chrono.TimeOfDay( hour, minute );
        ...
        {
            var action = Lambda.Of( () => new Core.Chrono.TimeOfDay( hour, minute ) );
            action.Should().Throw<ArgumentOutOfRangeException>();
        }
        ...
        {
            var sut = new Core.Chrono.TimeOfDay( hour, minute, second );
        ...
        {
            var action = Lambda.Of( () => new Core.Chrono.TimeOfDay( hour, minute, second ) );
            action.Should().Throw<ArgumentOutOfRangeException>();
        }
        ...
        {
            var sut = new Core.Chrono.TimeOfDay( hour, minute, second, ms );
        ...
        {
            var sut = new Core.Chrono.TimeOfDay( hour, minute, second, ms, tick );
        ...
        public void Ctor_WithTimeSpan_ShouldReturnCorrectResult(long ticks)
        {
            ...
            var sut = new Core.Chrono.TimeOfDay( timeSpan );
            ...
            using ( new AssertionScope() )
            {
                ...
                sut.Tick.Should().Be( (int)(timeSpan.Ticks % Constants.TicksPerMillisecond) );
            }
        }
        ...
        {
            var a = new Core.Chrono.TimeOfDay( TimeSpan.FromTicks( ticks1 ) );
            var b = new Core.Chrono.TimeOfDay( TimeSpan.FromTicks( ticks2 ) );
        ...
        {
            var sut = new Core.Chrono.TimeOfDay( TimeSpan.FromTicks( ticks1 ) );
            var other = new Core.Chrono.TimeOfDay( TimeSpan.FromTicks( ticks2 ) );
