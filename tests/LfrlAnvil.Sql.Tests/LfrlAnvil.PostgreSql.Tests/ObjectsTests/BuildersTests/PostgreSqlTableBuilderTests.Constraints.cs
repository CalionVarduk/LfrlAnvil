...
public partial class PostgreSqlTableBuilderTests
{
    public class Constraints : TestsBase
    {
        ...
        {
            var schema = PostgreSqlDatabaseBuilderMock.Create().Schemas.Default;
        ...
        {
            var schema = PostgreSqlDatabaseBuilderMock.Create().Schemas.Create( "foo" );
            var otherSchema = PostgreSqlDatabaseBuilderMock.Create().Schemas.Default;
            var t1 = schema.Objects.CreateTable( "T1" );
            var sut = t1.Constraints;
            var ix1 = t1.Constraints.SetPrimaryKey( t1.Columns.Create( "C1" ).Asc() ).Index;
        ...
        [Fact]
        public void GetPrimaryKey_ShouldThrowPostgreSqlObjectCastException_WhenPrimaryKeyDoesNotExist()
        {
            var schema = PostgreSqlDatabaseBuilderMock.Create().Schemas.Create( "foo" );
            var table = schema.Objects.CreateTable( "T" );
            var sut = table.Constraints;
