...
public partial class PostgreSqlSchemaBuilderTests
{
                    ...
                    exc => exc.TestType()
                        .Exact<SqlObjectCastException>(
                            e => Assertion.All(
                                ...
                                e.Actual.TestEquals( typeof( PostgreSqlPrimaryKeyBuilder ) ) ) ) )
                .Go();
        }
                    ...
                    exc => exc.TestType()
                        .Exact<SqlObjectCastException>(
                            e => Assertion.All(
                                ...
                                e.Actual.TestEquals( typeof( PostgreSqlTableBuilder ) ) ) ) )
                .Go();
        }
