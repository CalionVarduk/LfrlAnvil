...
public class MySqlConstantExpressionValidatorTests : TestsBase
{
    private readonly MySqlDatabaseBuilder _db = MySqlDatabaseBuilderMock.Create();
    private readonly MySqlConstantExpressionValidator _sut = new MySqlConstantExpressionValidator();
