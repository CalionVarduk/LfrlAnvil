...
public class MySqlDatabaseScopeExpressionValidatorTests : TestsBase
{
    private readonly MySqlDatabaseBuilder _db;
    private readonly MySqlDatabaseScopeExpressionValidator _sut;

    public MySqlDatabaseScopeExpressionValidatorTests()
    {
        _db = MySqlDatabaseBuilderMock.Create();
        _sut = new MySqlDatabaseScopeExpressionValidator( _db );
    }
    ...
    //     var node = SqlNode.RawDataField( new MySqlDatabaseMock( _db ).Schemas.Default.Objects.GetTable( "T" ).ToRecordSet(), "b" );
    //
    //     _sut.VisitRawDataField( node );
    //
    //     using ( new AssertionScope() )
    ...
    {
        var view = MySqlDatabaseBuilderMock.Create().Schemas.Default.Objects.CreateView( "V", SqlNode.RawQuery( "SELECT * FROM foo" ) );
        var node = view.ToRecordSet();
