...
public partial class SqliteTableBuilderTests : TestsBase
{
    ...
    public void ToString_ShouldReturnCorrectResult()
    {
        ...
        result.TestEquals( "[Table] foo_bar" ).Go();
    }
    ...
    public void Creation_ShouldPrepareCorrectStatement()
    {
        ...
        Assertion.All(
                ...
                schema.Database.Changes.ModifiedTables.TestSetEqual( [ sut ] ),
    ...
    public void SetName_ShouldUpdateName_WhenNameChangesAndTableHasExternalForeignKeyReferences()
    {
        ...
        Assertion.All(
                ...
                schema.Objects.TryGet( "T" ).TestNull(),
                schema.Database.Changes.ModifiedTables.TestSetEqual( [ t2, t3 ] ),
                fk1.IsRemoved.TestFalse(),
                fk2.IsRemoved.TestFalse(),
    ...
    public void SetName_ShouldUpdateName_WhenNameChangesAndTableHasExternalForeignKeyReferencesWithComputedColumns()
    {
        ...
        Assertion.All(
                ...
                schema.Objects.TryGet( "U" ).TestRefEquals( sut ),
                schema.Objects.TryGet( "T" ).TestNull(),
                schema.Database.Changes.ModifiedTables.TestSetEqual( [ t2 ] ),
                fk.IsRemoved.TestFalse(),
                actions.Select( a => a.Sql )
                    .TestSequence(
                    [
                        (sql, _) => sql.TestSatisfySql( "ALTER TABLE \"foo_T1\" RENAME TO \"foo_U\";" ),
    ...
    public void SetName_ShouldUpdateName_WhenNameChangesAndTableHasExternalForeignKeyReferencesAndChangedTableHasOtherPendingChanges()
    {
        ...
        Assertion.All(
                ...
                schema.Database.Changes.ModifiedTables.TestSetEqual( [ sut, t2 ] ),
                fk1.IsRemoved.TestFalse(),
                actions.Select( a => a.Sql )
                    .TestSequence(
                    [
    ...
    public void Remove_ShouldRemoveTableAndQuickRemoveColumnsAndConstraints()
    {
        ...
        Assertion.All(
                ...
                schema.Database.Changes.ModifiedTables.TestSetEqual( [ otherTable ] ),
    ...
    [Fact]
    public void ReconstructionChanges_ShouldGenerateCorrectScript_WithIdentityColumn()
    {
        var schema = SqliteDatabaseBuilderMock.Create().Schemas.Create( "foo" );
        var sut = schema.Objects.CreateTable( "T" );
        sut.Constraints.SetPrimaryKey( sut.Columns.Create( "C1" ).SetType<int>().SetIdentity( SqlColumnIdentity.Default ).Asc() );
        var c = sut.Columns.Create( "C2" );

        var actionCount = schema.Database.GetPendingActionCount();
        c.SetDefaultValue( 123 );
        var actions = schema.Database.GetLastPendingActions( actionCount );
