    ...
    public class Checks : TestsBase
    {
        ...
        public void Create_ShouldCreateNewCheck()
        {
            ...
            using ( new AssertionScope() )
            {
                ...
                result.FullName.Should().Be( "foo_CHK_T_0" );
        ...
        [Fact]
        public void Create_ShouldThrowSqliteObjectBuilderException_WhenCheckAlreadyExists()
        {
            var schema = SqliteDatabaseBuilderMock.Create().Schemas.Create( "foo" );
            var table = schema.Objects.CreateTable( "T" );
            var sut = table.Checks;
        ...
        [Fact]
        public void Create_ShouldThrowSqliteObjectBuilderException_WhenCheckAlreadyExistsDueToOtherTable()
        {
            var schema = SqliteDatabaseBuilderMock.Create().Schemas.Create( "foo" );
        ...
        [Fact]
        public void Create_ShouldThrowSqliteObjectBuilderException_WhenConditionIsInvalid()
        {
            var schema = SqliteDatabaseBuilderMock.Create().Schemas.Create( "foo" );
            var table = schema.Objects.CreateTable( "T" );
