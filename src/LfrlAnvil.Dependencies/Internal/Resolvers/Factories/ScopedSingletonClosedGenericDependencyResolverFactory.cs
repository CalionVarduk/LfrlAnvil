...
internal sealed class ScopedSingletonClosedGenericDependencyResolverFactory : RegisteredClosedGenericDependencyResolverFactory
{
    internal ScopedSingletonClosedGenericDependencyResolverFactory(
