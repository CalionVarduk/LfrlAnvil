...
/// <summary>
/// Represents custom open generic dependency constructor invocation options.
/// </summary>
public interface IOpenGenericDependencyConstructorInvocationOptions
{
    /// <summary>
    ...
    /// </summary>
    IReadOnlyList<OpenGenericInjectableDependencyResolution<ParameterInfo>> ParameterResolutions { get; }

    /// <summary>
    /// Contains all registered custom injectable member resolutions.
    /// </summary>
    IReadOnlyList<OpenGenericInjectableDependencyResolution<MemberInfo>> MemberResolutions { get; }
    ...
    IOpenGenericDependencyConstructorInvocationOptions SetOnCreatedCallback(Action<object, Type, IDependencyScope>? callback);
    ...
    /// <returns><b>this</b>.</returns>
    IOpenGenericDependencyConstructorInvocationOptions ResolveParameter(
    ...
    /// <param name="configuration">Optional implementor configurator.</param>
    /// <returns><b>this</b>.</returns>
    IOpenGenericDependencyConstructorInvocationOptions ResolveMember(
    ...
    /// </summary>
    /// <returns><b>this</b>.</returns>
    IOpenGenericDependencyConstructorInvocationOptions ClearParameterResolutions();

    /// <summary>
    /// Removes all registered custom injectable member resolutions from this instance.
    /// </summary>
    /// <returns><b>this</b>.</returns>
    IOpenGenericDependencyConstructorInvocationOptions ClearMemberResolutions();
}
