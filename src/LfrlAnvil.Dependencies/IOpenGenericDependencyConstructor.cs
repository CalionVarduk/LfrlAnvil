...
/// <summary>
/// Represents a constructor of open generic dependency instances.
/// </summary>
public interface IOpenGenericDependencyConstructor
{
    /// <summary>
    ...
    /// </description></item>
    /// <item><description>
    /// Each parameter with a custom resolution that is not a captive dependency adds 3 points.
    /// </description></item>
    /// <item><description>Each automatically resolvable parameter that is not a captive dependency adds 2 points.</description></item>
    /// <item><description>
    /// Each unresolvable optional parameter (e.g. with a default value) with a custom resolution adds 2 points.
    /// </description></item>
    /// <item><description>Each unresolvable optional parameter (e.g. with a default value) adds 1 point.</description></item>
    /// <item><description>
    /// Each parameter with a custom resolution that is a captive dependency adds 1 point.
    /// </description></item>
    /// </list>
    ...
    /// </summary>
    IOpenGenericDependencyConstructorInvocationOptions InvocationOptions { get; }
}
