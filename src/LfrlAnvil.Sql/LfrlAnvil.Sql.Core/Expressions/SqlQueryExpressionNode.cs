...
public sealed class SqlQueryExpressionNode : SqlExpressionNode
{
    internal SqlQueryExpressionNode(SqlDataSourceNode dataSource, SqlSelectNode[] selection)
    ...
    internal SqlQueryExpressionNode(SqlDataSourceDecoratorNode decorator, SqlSelectNode[] selection)
        : base( SqlNodeType.Query )
    {
    ...
    public ReadOnlyMemory<SqlSelectNode> Selection { get; }
