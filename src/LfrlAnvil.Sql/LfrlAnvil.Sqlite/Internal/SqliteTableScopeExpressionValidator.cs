...
internal sealed class SqliteTableScopeExpressionValidator : SqliteExpressionValidator
{
    internal SqliteTableScopeExpressionValidator(SqliteTableBuilder table)
    {
        Table = table;
