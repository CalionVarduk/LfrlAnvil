...
/// <summary>
/// Represents a delegate that returns <see cref="Boolean"/> and has a two parameters
...
/// <summary>
/// Represents a delegate that returns <see cref="Boolean"/> and has a three parameters
/// with the last one being an <b>out</b> parameter of <typeparamref name="TResult"/> type.
/// </summary>
/// <typeparam name="T1">Type of the first parameter..</typeparam>
...
/// <summary>
/// Represents a delegate that returns <see cref="Boolean"/> and has a four parameters
/// with the last one being an <b>out</b> parameter of <typeparamref name="TResult"/> type.
/// </summary>
/// <typeparam name="T1">Type of the first parameter..</typeparam>
/// <typeparam name="T2">Type of the second parameter..</typeparam>
