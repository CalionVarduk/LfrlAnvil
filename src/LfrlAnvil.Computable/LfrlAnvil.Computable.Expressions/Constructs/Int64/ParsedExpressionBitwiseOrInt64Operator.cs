...
/// <summary>
/// Represents a <see cref="Int64"/> binary bitwise or operator construct.
/// </summary>
public sealed class ParsedExpressionBitwiseOrInt64Operator : ParsedExpressionBinaryOperator<long>
{
    /// <inheritdoc />
    [Pure]
