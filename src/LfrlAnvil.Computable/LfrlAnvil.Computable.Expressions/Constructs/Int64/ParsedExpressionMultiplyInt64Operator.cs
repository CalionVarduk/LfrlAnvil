...
/// <summary>
/// Represents a <see cref="Int64"/> binary multiply operator construct.
/// </summary>
public sealed class ParsedExpressionMultiplyInt64Operator : ParsedExpressionBinaryOperator<long>
{
    /// <inheritdoc />
    [Pure]
