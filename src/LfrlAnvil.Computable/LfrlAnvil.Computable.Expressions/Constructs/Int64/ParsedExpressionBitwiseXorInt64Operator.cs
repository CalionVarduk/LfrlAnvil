...
/// <summary>
/// Represents a <see cref="Int64"/> binary bitwise xor operator construct.
/// </summary>
public sealed class ParsedExpressionBitwiseXorInt64Operator : ParsedExpressionBinaryOperator<long>
{
    /// <inheritdoc />
    [Pure]
