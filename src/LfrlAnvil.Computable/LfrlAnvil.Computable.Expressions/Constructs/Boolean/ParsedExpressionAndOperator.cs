...
/// <summary>
/// Represents a <see cref="Boolean"/> binary logical and operator construct.
/// </summary>
public sealed class ParsedExpressionAndOperator : ParsedExpressionBinaryOperator<bool>
{
    /// <inheritdoc />
    [Pure]
