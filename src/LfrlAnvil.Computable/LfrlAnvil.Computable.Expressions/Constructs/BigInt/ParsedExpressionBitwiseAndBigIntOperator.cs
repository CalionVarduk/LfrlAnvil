...
/// <summary>
/// Represents a <see cref="BigInteger"/> binary bitwise and operator construct.
/// </summary>
public sealed class ParsedExpressionBitwiseAndBigIntOperator : ParsedExpressionBinaryOperator<BigInteger>
{
    /// <inheritdoc />
    [Pure]
