...
/// <summary>
/// Represents a <see cref="BigInteger"/> binary subtract operator construct.
/// </summary>
public sealed class ParsedExpressionSubtractBigIntOperator : ParsedExpressionBinaryOperator<BigInteger>
{
    /// <inheritdoc />
    [Pure]
