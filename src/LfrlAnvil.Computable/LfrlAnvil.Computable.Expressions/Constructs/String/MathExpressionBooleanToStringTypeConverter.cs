...
public sealed class MathExpressionBooleanToStringTypeConverter : MathExpressionTypeConverter<string, bool>
{
    private readonly MethodInfo _toString;
    private readonly ConstantExpression _formatProvider;

    public MathExpressionBooleanToStringTypeConverter(IFormatProvider? formatProvider = null)
    {
