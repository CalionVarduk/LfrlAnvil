...
/// <summary>
/// Represents a <see cref="Int32"/> binary bitwise and operator construct.
/// </summary>
public sealed class ParsedExpressionBitwiseAndInt32Operator : ParsedExpressionBinaryOperator<int>
{
    /// <inheritdoc />
    [Pure]
