...
/// <summary>
/// Represents an event emitted by <see cref="MessageBrokerRemoteClient"/> related to a listener being successfully bound.
/// </summary>
public readonly struct MessageBrokerRemoteClientListenerBoundEvent
{
    ...
    public override string ToString()
    {
        ...
        return
            $"[ListenerBound] {Source}, Channel = [{Listener.Channel.Id}] '{Listener.Channel.Name}'{channelCreated}, Queue = [{queue.Id}] '{queue.Name}'{queueCreated}{reactivated}";
    }

    [Pure]
    [MethodImpl( MethodImplOptions.AggressiveInlining )]
    internal static MessageBrokerRemoteClientListenerBoundEvent Create(
        MessageBrokerChannelListenerBinding listener,
        ulong traceId,
        bool channelCreated,
        bool queueCreated,
